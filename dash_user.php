...
// Query untuk mengambil daftar tugas berdasarkan user_id
...
<div class="side-menu">
        ...
        <ul>
            <li> <a href="dash_user.php" class="active"><img src="../image/dashboard (2).png">&nbsp;<span>Dashboard</span></a></li>
            <li> <a href="proyek.php"> <img src="../image/reading-book (1).png" alt="">&nbsp;<span>Proyek Saya</span></a></li>
