...
// Query untuk mengambil daftar tugas berdasarkan ID user dan divisi
$query_tugas = "SELECT tugas.*, proyek.nama FROM tugas
...
<head>
    ...
    <title>Data Tugas dan Proyek</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-5">
        <h2>Data Proyek dan Tugas</h2>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                if ($result_proyek->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='5' class='text-center'>Tidak ada proyek untuk divisi ini</td></tr>";
                }
                ?>
            </tbody>
        </table>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                if ($result_tugas->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='7' class='text-center'>Tidak ada tugas untuk Anda</td></tr>";
                }
                ?>
            </tbody>
        </table>
